...
- HTML: the _content_ on the page (text, buttons, images etc).
- CSS: the _presentation_ styling and layout of the elements on the page.
...
React, Angular and VUE are JavaScript Frameworks and should **_NOT_** be used until I am good at JavaScript.
